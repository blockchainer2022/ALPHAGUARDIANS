  ...
  return (
    ...
    <Header/>  
      <Container className={classes.root}>
        <h1>Alpha Guardians</h1>
        <p style={{textTransform:"uppercase"}}>The Battle Lines Are Drawn</p>  
        <p>A collection of 6000 NFT's on Solana</p> 

       <div className={classes.icon}>
          {/* <a href="" rel="noreferrer" target="_blank"><img src={Discord} alt="" /></a> */}
        ...
        <h4>Mint</h4>
        <p  style={{marginTop:10,fontSize:18}}>Mint Time Is 26th Dec 2021</p>
       { difference < 0 ?
       <div>
       ...
       :(
         <>
          ...
          <div className={classes.bottom}>
            <h6>Minting cost?</h6>
            <br/>
            <p>0.05 sol for each Alpha Guardians</p>
          </div>
